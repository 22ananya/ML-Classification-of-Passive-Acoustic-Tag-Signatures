...
x_train = np.load(data_path + 'Dataset_v01_x_train.npy')
y_train = np.load(data_path + 'Dataset_v01_y_train.npy')
n,d = x_train.shape
...
x_test = np.load(data_path + 'Dataset_v01_x_test.npy')
y_test = np.load(data_path + 'Dataset_v01_y_test.npy')
